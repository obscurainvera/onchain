...
class Notification:
    ...
    # Optional fields
    id: Optional[int] = None
    tokenid: Optional[str] = None  # Token ID for token-specific notifications
    strategytype: Optional[str] = None  # From NotificationStrategyType enum
...
@dataclass
class TradingAttentionInfo:
    """Trading attention information data structure"""
