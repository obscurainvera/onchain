    ...
    def sendMessage(self, source: NotificationSource, content: Union[str, TokenNotificationContent], 
        ...
        try:
            ...
            if isinstance(content, TokenNotificationContent):
                ...
                # Extract tokenid and strategytype for spam prevention
                tokenid = content.tokenid
                strategytype = content.subject  # The subject contains the strategy name
            ...
            # 1. Create notification object with tokenid and strategytype
            notification = self.createNotification(source, content_str, chatGroup, buttons, tokenid, strategytype)
