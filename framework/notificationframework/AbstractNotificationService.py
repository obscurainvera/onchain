...
class AbstractNotificationService(ABC):
    ...
    def createNotification(self, source: NotificationSource, content: str, 
                          ...
                          strategytype: Optional[str] = None) -> Notification:
        """
        ...
        Args:
            ...
            tokenid: Optional token ID for token-specific notifications
            strategytype: Optional strategy type (from NotificationStrategyType enum)
